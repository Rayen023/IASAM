				...
				<div class="row">
					...
					<div style="margin-top:-55px" class="col-lg-4 footer_col">
						...
						<div class="social footer_social">
							<ul class="d-flex flex-row align-items-center justify-content-start">
								...
								<li><a target="_blank" href="https://twitter.com/IEEEIASTAM2020"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
								<li><a target="_blank" href="#"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
								<li><a target="_blank" href="https://www.instagram.com/iastnam/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
					...
					<div style="margin-top:-80px" class="col-lg-4 footer_col">
						<div class="footer_column">
                            ...
                            <div style="margin-top:0" class="social footer_social">
                                <ul class="d-flex flex-row align-items-center justify-content-start">
